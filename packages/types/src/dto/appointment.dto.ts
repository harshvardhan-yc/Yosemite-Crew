import type { Appointment as FHIRAppointment } from '@yosemite-crew/fhir';
...
export const fromAppointmentRequestDTO = (dto: AppointmentRequestDTO): Appointment => {
...
export const toAppointmentResponseDTO = (appointment: Appointment): AppointmentResponseDTO => {
