import type { Patient } from '@yosemite-crew/fhir';
 ...
 */
export const fromCompanionRequestDTO = (dto: CompanionRequestDTO): Companion => {
 ...
 */
export const toCompanionResponseDTO = (companion: Companion): CompanionResponseDTO => {
