...
describe('preload bridge', () => {
  ...
  describe('methods invoke correct IPC channels', () => {
    ...
    const cases: TestCase[] = [
      ...
      { name: 'setSettings', channel: 'yc:set-settings', args: [{ theme: 'dark' }] },
      { name: 'executeCommand', channel: 'yc:execute-command', args: ['cmd-palette-1'] },
      ...
      { name: 'showNotification', channel: 'yc:show-notification', args: [{ title: 'Hello' }] },
      { name: 'authenticateBiometric', channel: 'yc:authenticate-biometric', args: ['unlock'] },
      { name: 'applyTheme', channel: 'yc:apply-theme' },
      { name: 'openPatientWindow', channel: 'yc:open-patient-window', args: ['p-456', 'Buddy'] },
      { name: 'csRecord', channel: 'yc:cs-record', args: [{ drug: 'Ketamine' }] },
      { name: 'csExport', channel: 'yc:cs-export', args: ['2024-06-15'] },
      { name: 'auditAppend', channel: 'yc:audit-append', args: [{ action: 'create' }] },
      {
        name: 'vaultSave',
      ...
      { name: 'vaultRevealDoc', channel: 'yc:vault-reveal-doc', args: ['doc-1'] },
      { name: 'vaultOpen', channel: 'yc:vault-open' },
      { name: 'deaRegister', channel: 'yc:dea-register', args: [{ number: 'DEA-123' }] },
      { name: 'getCachedContent', channel: 'yc:get-cached-content', args: ['https://example.com'] },
      ...
      { name: 'setTabOrientation', channel: 'yc:tab-set-orientation', args: ['vertical'] },
      ...
      { name: 'setLastSeenVersion', channel: 'yc:set-last-seen-version', args: ['1.0.0'] },
