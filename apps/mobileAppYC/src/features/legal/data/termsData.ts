...
export const TERMS_SECTIONS: LegalSection[] = [
  {
    ...
    blocks: [
      createNumberedParagraph(
        ...
        seg(' '),
        seg(
          `${COMPANY_NAME}, ${COMPANY_FULL_ADDRESS} ("DuneXploration" or "we/us/our") provides a Mobile App for Pet Owners/Companion Owners that is accessible via app stores for supported mobile devices.`,
        ),
      ),
      createNumberedParagraph(
        '1.2.',
  ...
  },
  {
    ...
    blocks: [
      ...
      createDefinition(
        '2.2.',
        'Pet Professionals/Pet Businesses',
  ...
  },
  {
    ...
    blocks: [
      ...
      createNumberedParagraph(
        '4.1.2.',
        seg(
          ' In the Mobile App, the Pet Owner/Companion Owner can (among other things)',
        ),
      ),
      createBulletList(
        'Create pet profiles,',
      ...
      createNumberedParagraph(
        '4.3.2.',
        seg(' The Pet Owner/Companion Owner can also'),
      ),
      createRomanList(
  ...
  },
  {
    ...
    blocks: [
      createNumberedParagraph(
        '6.1.',
        seg(' Sign-up and Using the Mobile App is free of charge.'),
      ),
      createNumberedParagraph(
        '6.2.',
        seg(
  ...
  },
  {
    ...
    blocks: [
      ...
      createNumberedParagraph(
        '8.1.3.',
        seg(
          ' Advertising content for third-party products and services is also prohibited.',
        ),
      ),
      ...
      createSubsectionHeader(
        '8.3.',
        'Verification, Checks and Moderation of Reviews',
      ),
      createNumberedParagraph(
        '8.3.1.',
        seg(
      ...
      createSubsectionHeader(
        '8.7.',
        'Liability and Indemnification for reviews',
      ),
      createNumberedParagraph(
        '8.7.1.',
        seg(
          ' Pet Owners/Companion Owners are liable for the reviews they publish.',
        ),
      ),
      createNumberedParagraph(
        '8.7.2.',
  ...
  createContactSection(
    '16. If you have any comments or questions',
    'contact-questions',
  ),
  {
    id: 'availability',
  ...
  },
  {
    ...
    blocks: [
      createNumberedParagraph(
        '13.1.',
        seg(
          ' DuneXploration shall be liable in accordance with the statutory provisions.',
        ),
      ),
      createNumberedParagraph(
        '13.2.',
