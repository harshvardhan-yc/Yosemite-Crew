...
jest.mock('../../src/services/form.service', () => {
  ...
  const actual = jest.requireActual('../../src/services/form.service') as unknown as any;
  return {
    ...actual,
    FormService: {
      create: jest.fn(),
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const { FormServiceError } = jest.requireActual('../../src/services/form.service') as unknown as any;
...
describe('FormController', () => {
  ...
  // ----------------------------------------------------------------------
  const mockServiceError = (method: keyof typeof FormService, status = 400, msg = 'Service Error') => {
  ...
  describe('createForm', () => {
    ...
    it('should success (201)', async () => {
      ...
      expect(mockedFormService.create).toHaveBeenCalledWith('o1', req.body, 'u1');
  ...
  describe('getFormForAdmin', () => {
    it('should success (200)', async () => {
      ...
      expect(mockedFormService.getFormForAdmin).toHaveBeenCalledWith('o1', 'f1');
  ...
  describe('getFormListForOrganisation', () => {
    it('should success (200)', async () => {
      ...
      await FormController.getFormListForOrganisation(req as any, res as Response);
      expect(mockedFormService.listFormsForOrganisation).toHaveBeenCalledWith('o1');
      expect(statusMock).toHaveBeenCalledWith(200);
    });
  ...
  describe('updateForm', () => {
    ...
    it('should success (200)', async () => {
      ...
      await FormController.updateForm(req as any, res as Response);
      expect(mockedFormService.update).toHaveBeenCalledWith('f1', req.body, 'u1', 'o1');
      expect(statusMock).toHaveBeenCalledWith(200);
    });
  ...
  describe('getSOAPNotesByAppointment', () => {
    it('should success (200) with latestOnly true', async () => {
      ...
      await FormController.getSOAPNotesByAppointment(req as any, res as Response);
      expect(mockedFormService.getSOAPNotesByAppointment).toHaveBeenCalledWith('a1', { latestOnly: true });
      expect(statusMock).toHaveBeenCalledWith(200);
    });
    ...
    it('should success (200) with latestOnly false', async () => {
      ...
      await FormController.getSOAPNotesByAppointment(req as any, res as Response);
      expect(mockedFormService.getSOAPNotesByAppointment).toHaveBeenCalledWith('a1', { latestOnly: false });
      expect(statusMock).toHaveBeenCalledWith(200);
    });
  ...
  describe('getConsentFormForParent', () => {
    it('should success (200) with all params', async () => {
      ...
      expect(mockedFormService.getConsentFormForParent).toHaveBeenCalledWith('o1', { serviceId: 's1', species: 'dog' });
      expect(statusMock).toHaveBeenCalledWith(200);
    });
    ...
    it('should success (200) with undefined species', async () => {
      ...
      await FormController.getConsentFormForParent(req as any, res as Response);
      expect(mockedFormService.getConsentFormForParent).toHaveBeenCalledWith('o1', { serviceId: 's1', species: undefined });
      expect(statusMock).toHaveBeenCalledWith(200);
    });
  ...
  describe('getFormsForAppointment', () => {
    ...
    it('should success (200) with full params', async () => {
      ...
      await FormController.getFormsForAppointment(req as any, res as Response);
      expect(mockedFormService.getFormsForAppointment).toHaveBeenCalledWith({ appointmentId: 'a1', serviceId: 's1', species: 'cat' });
      expect(statusMock).toHaveBeenCalledWith(200);
    });
    ...
    it('should success (200) with minimal params', async () => {
      ...
      await FormController.getFormsForAppointment(req as any, res as Response);
      expect(mockedFormService.getFormsForAppointment).toHaveBeenCalledWith({ appointmentId: 'a1', serviceId: undefined, species: undefined });
      expect(statusMock).toHaveBeenCalledWith(200);
    });
  ...
  describe('getFormSubmissionPDF', () => {
    it('should success (200)', async () => {
      ...
      expect(res.setHeader).toHaveBeenCalledWith('Content-Disposition', expect.stringContaining('s1.pdf'));
