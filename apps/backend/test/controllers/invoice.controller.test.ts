...
const { InventoryServiceError: RealInventoryServiceError } = jest.requireActual('../../src/services/inventory.service') as any;
  ...
  describe('InventoryController', () => {
    ...
    describe('createItem', () => {
      it('should success (201)', async () => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (mockedInventoryService.createItem as any).mockResolvedValue({ id: 'i1' });
    ...
    describe('updateItem', () => {
      it('should success (200)', async () => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (mockedInventoryService.updateItem as any).mockResolvedValue({ id: 'i1' });

        await InventoryController.updateItem(req as any, res as Response);
        expect(mockedInventoryService.updateItem).toHaveBeenCalledWith('i1', req.body);
    ...
    describe('hideItem', () => {
      it('should success (200)', async () => {
        req.params = { itemId: 'i1' };
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (mockedInventoryService.hideItem as any).mockResolvedValue({ id: 'i1' });
    ...
    describe('activeItem', () => {
      it('should success (200)', async () => {
        req.params = { itemId: 'i1' };
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (mockedInventoryService.activeItem as any).mockResolvedValue({ id: 'i1' });
    ...
    describe('archiveItem', () => {
      it('should success (200)', async () => {
        req.params = { itemId: 'i1' };
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (mockedInventoryService.archiveItem as any).mockResolvedValue({ id: 'i1' });
    ...
    describe('listItems', () => {
      it('should parse status string (single)', async () => {
        ...
        expect(mockedInventoryService.listItems).toHaveBeenCalledWith(expect.objectContaining({
          status: 'ACTIVE',
          lowStockOnly: true
        }));
      });
    ...
    describe('getItemWithBatches', () => {
      it('should success', async () => {
        ...
        await InventoryController.getItemWithBatches(req as any, res as Response);
        expect(mockedInventoryService.getItemWithBatches).toHaveBeenCalledWith('i1', 'o1');
      });

      it('should handle error', async () => {
        mockGenericError(mockedInventoryService.getItemWithBatches as jest.Mock);
        await InventoryController.getItemWithBatches(req as any, res as Response);
        expect(statusMock).toHaveBeenCalledWith(500);
      });
    });
    ...
    describe('updateBatch', () => {
      it('should success', async () => {
        ...
        expect(mockedInventoryService.updateBatch).toHaveBeenCalledWith('b1', req.body);
      });
    ...
    describe('deleteBatch', () => {
      it('should success (204)', async () => {
        req.params = { batchId: 'b1' };
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (mockedInventoryService.deleteBatch as any).mockResolvedValue(undefined);
    ...
    describe('consumeStock', () => {
      it('should success', async () => {
        ...
        expect(mockedInventoryService.consumeStock).toHaveBeenCalledWith(req.body);
      });
    ...
    describe('adjustStock', () => {
      it('should success with header userId', async () => {
        ...
        expect(mockedAdjustmentService.adjustStock).toHaveBeenCalledWith(expect.objectContaining({
          userId: 'u1'
        }));
      });
    ...
    describe('releaseAllocatedStock', () => {
      it('should success', async () => {
        ...
        req.body = { quantity: 2, referenceId: 'ref1' };
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (mockedAllocationService.releaseAllocatedStock as any).mockResolvedValue({});
        await InventoryController.releaseAllocatedStock(req as any, res as Response);
        expect(mockedAllocationService.releaseAllocatedStock).toHaveBeenCalled();
      });

      it('should handle error', async () => {
        mockGenericError(mockedAllocationService.releaseAllocatedStock as jest.Mock);
        await InventoryController.releaseAllocatedStock(req as any, res as Response);
        expect(statusMock).toHaveBeenCalledWith(500);
      });
    });
    ...
    describe('getInventoryTurnOver', () => {
      it('should success with defaults', async () => {
        ...
        req.query = {};
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (mockedInventoryService.getInventoryTurnoverByItem as any).mockResolvedValue([]);

        await InventoryController.getInventoryTurnOver(req as any, res as Response);
        expect(mockedInventoryService.getInventoryTurnoverByItem).toHaveBeenCalledWith(expect.objectContaining({
          from: undefined,
          to: undefined
        }));
      ...
      it('should handle service error', async () => {
        mockServiceError(mockedInventoryService.getInventoryTurnoverByItem as jest.Mock, 400);
        await InventoryController.getInventoryTurnOver(req as any, res as Response);
      });

      it('should handle generic error', async () => {
        mockGenericError(mockedInventoryService.getInventoryTurnoverByItem as jest.Mock);
        await InventoryController.getInventoryTurnOver(req as any, res as Response);
        expect(statusMock).toHaveBeenCalledWith(500);
      });
    });
  ...
  describe('InventoryVendorController', () => {
    describe('createVendor', () => {
      it('should success (201)', async () => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (mockedVendorService.createVendor as any).mockResolvedValue({ id: 'v1' });
        await InventoryVendorController.createVendor(req as any, res as Response);
        expect(statusMock).toHaveBeenCalledWith(201);
      });
    ...
    describe('updateVendor', () => {
      it('should success', async () => {
        ...
        await InventoryVendorController.updateVendor(req as any, res as Response);
        expect(jsonMock).toHaveBeenCalled();
      });
    ...
    describe('listVendors', () => {
      it('should success', async () => {
        ...
        await InventoryVendorController.listVendors(req as any, res as Response);
        expect(jsonMock).toHaveBeenCalled();
      });
    ...
    describe('deleteVendor', () => {
      it('should success (204)', async () => {
        ...
        await InventoryVendorController.deleteVendor(req as any, res as Response);
        expect(statusMock).toHaveBeenCalledWith(204);
      });
  ...
  describe('InventoryMetaFieldController', () => {
    describe('createField', () => {
      it('should success (201)', async () => {
        ...
        await InventoryMetaFieldController.createField(req as any, res as Response);
        expect(statusMock).toHaveBeenCalledWith(201);
      });
    ...
    describe('updateField', () => {
      it('should success', async () => {
        ...
        await InventoryMetaFieldController.updateField(req as any, res as Response);
        expect(jsonMock).toHaveBeenCalled();
      });
    ...
    describe('deleteField', () => {
      it('should success (204)', async () => {
        req.params = { fieldId: 'f1' };
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (mockedMetaFieldService.deleteField as any).mockResolvedValue(undefined);
        await InventoryMetaFieldController.deleteField(req as any, res as Response);
        expect(statusMock).toHaveBeenCalledWith(204);
      });
    ...
    describe('listFields', () => {
      it('should 400 if businessType missing', async () => {
        req.query = {};
        await InventoryMetaFieldController.listFields(req as any, res as Response);
  ...
  describe('InventoryAlertController', () => {
    describe('getLowStockItems', () => {
      it('should success', async () => {
        ...
        await InventoryAlertController.getLowStockItems(req as any, res as Response);
        expect(jsonMock).toHaveBeenCalled();
      });
    ...
    describe('getExpiringItems', () => {
      it('should success with default days', async () => {
        ...
        await InventoryAlertController.getExpiringItems(req as any, res as Response);
        expect(mockedAlertService.getExpiringItems).toHaveBeenCalledWith('o1', 7);
      });
      ...
      it('should success with explicit days', async () => {
        ...
        (mockedAlertService.getExpiringItems as any).mockResolvedValue([]);
        await InventoryAlertController.getExpiringItems(req as any, res as Response);
        expect(mockedAlertService.getExpiringItems).toHaveBeenCalledWith('o1', 15);
      });
