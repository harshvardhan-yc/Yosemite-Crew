...
const ParentCompanionSchema = new Schema<ParentCompanionMongo>(
    {
        ...
        companionId: { type: Schema.Types.ObjectId, ref: 'Companion', required: true, index: true },
...
export const toCompanionParentLink = (document: ParentCompanionDocument): CompanionParentLink => {
...
const ParentCompanionModel = model<ParentCompanionMongo>('ParentCompanion', ParentCompanionSchema)
