...
router.delete("/:id", authorizeCognito, OrganizationController.deleteBusinessById)
...
router.post("/logo/presigned-url/:orgId", OrganizationController.getLogoUploadUrl)
