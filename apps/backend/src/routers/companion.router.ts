...
router.post('/', authorizeCognitoMobile , CompanionController.createCompanionMobile)
router.get('/:id', authorizeCognitoMobile ,CompanionController.getCompanionById)
router.put('/:id', authorizeCognitoMobile, CompanionController.updateCompanion)
router.delete('/:id', authorizeCognitoMobile, CompanionController.deleteCompanion)
router.post('/profile/presigned', authorizeCognitoMobile, CompanionController.getProfileUploadUrl)
