...
export const AuthUserMobileController = {
    ...
    try {
      ...
      const parent = await AuthUserMobileService.autoLinkParentByEmail(authUser);
    ...
    try {
      ...
      const updatedUser = await AuthUserMobileService.linkParent(authUserId!, parentId);
    ...
    try {
      ...
      const user = await AuthUserMobileService.getByProviderUserId(providerUserId);
