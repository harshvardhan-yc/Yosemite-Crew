...
const InviteCard = ({ invite, handleAccept, handleReject }: InviteCardProps) => {
  return (
    <div className="invite-card">
      ...
      <div className="invite-card-item">
        ...
        <div className="text-caption-1 text-text-primary">{toTitleCase(invite.role)}</div>
      </div>
      <div className="invite-card-item">
        <div className="text-caption-1 text-text-extra">Employee type :</div>
        <div className="text-caption-1 text-text-primary">{toTitle(invite.employmentType)}</div>
      </div>
      <div className="invite-card-actions">
        <button type="button" onClick={() => handleAccept(invite)} className="invite-card-action">
          Accept
        </button>
        <button type="button" onClick={() => handleReject(invite)} className="invite-card-action">
          Decline
        </button>
      </div>
    </div>
