...
const baseClasses =
  'px-4 gap-2 flex items-center justify-center rounded-2xl! transition-all duration-300 ease-in-out text-body-3-emphasis text-center font-satoshi border border-text-primary! text-text-primary! hover:text-text-brand! hover:border-text-brand!';
