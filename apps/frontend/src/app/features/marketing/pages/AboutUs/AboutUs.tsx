            ...
            <div className="AbutheroBtm">
              ...
              <div className="abtherocard">
                <div className="AbtCardItem">
                  ...
                  <div className="body">
                    <div className="text-body-3 text-text-secondary">
                      Because, let&rsquo;s face it, the pet business world is chaotic. Juggling
                      appointments, patient records, billing, and communication shouldn&rsquo;t be a
                      daily struggle. The PMS industry is cluttered, complicated, and outdated.
                ...
                <div className="AbtCardItem">
                  ...
                  <div className="body">
                    <div className="text-body-3 text-text-secondary">
                      Empower the pet business ecosystem with a platform that actually works.
                      We&rsquo;ve got your back whether you&rsquo;re a solo vet, a clinic manager,
                      or a tech-savvy developer ready to build tools that matter.
                    </div>
                  </div>
                </div>
                ...
                <div className="AbtCardItem">
                  ...
                  <div className="body">
                    <div className="text-body-3 text-text-secondary">
                      We&rsquo;re not just here to help you book appointments or track patient
                      history. We&rsquo;re building a multi-verse of smart, connected tools to make
                      your practice run smoother, faster, and better. Think of us as your one-stop
      ...
      <section className="OurStorySec">
        <div className="Container">
          <div className="StoryData">
            <Image
              src={MEDIA_SOURCES.aboutUs.storyImage}
              alt="aboutstory"
              width={605}
              height={515}
            />
            ...
            <div className="storyTexted">
              ...
              <div className="ourstorypara">
                <div className="text-body-3 text-text-secondary">
                  ...
                  Ankit was leading animal health projects, one thing became crystal clear: too many
                  systems were driven by money, overloaded with complexity, and lacked real user
                  integration. More work. More confusion. Less clarity.
                </div>
                <div className="text-body-3 text-text-secondary">
                  So, we asked ourselves : what if we flipped the script? <br /> What if we created
                  something smarter, friendlier, and actually built around the people who use it?
                </div>
                <div className="text-body-3 text-text-secondary">
                  Yosemite Crew was born from that idea. A digital space where simplicity meets
                  interactivity, where products are easy to use, easy to recognise, and most
                  importantly easy to love. We&apos;ve spent our time deeply understanding user
                  problems so we can solve them, not add to them.
                </div>
              </div>
            </div>
          </div>
