...
import Subjective from "../../../../../../pages/Appointments/Sections/AppointmentInfo/Prescription/Subjective";
...
jest.mock(
  "../../../../../../pages/Appointments/Sections/AppointmentInfo/Prescription/Submissions/SubjectiveSubmissions",
  () => ({
    __esModule: true,
    default: () => (
      <div data-testid="subjective-submissions">Submissions List</div>
    ),
  })
);
...
describe("Subjective Section", () => {
  ...
  const mockForms = [
    { _id: "form-1", name: "History Form", schema: [{ id: "field1" }] },
    { _id: "form-2", name: "Diet History", schema: [] },
  ];
  ...
  it("renders the basic layout correctly", () => {
    ...
    expect(screen.getByTestId("subjective-submissions")).toBeInTheDocument();
  ...
  it("updates values and submits the form successfully", async () => {
    ...
    fireEvent.change(input, { target: { value: "Patient history notes" } });
    ...
    const expectedSubmission = {
      ...
      companionId: "comp-1",
      parentId: "parent-1",
      answers: { field1: "Patient history notes" },
