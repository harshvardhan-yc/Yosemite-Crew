...
jest.mock("@/app/pages/Appointments/Sections/AppointmentInfo/Prescription/Submissions/AssessmentSubmissions", () => () => (
  <div data-testid="assessment-submissions" />
));

describe("Assessment prescription", () => {
  ...
  beforeEach(() => {
    ...
    formsMock.mockReturnValue([
      { _id: "form-1", name: "Assessment Form", schema: [] },
    ]);
