...
describe('Header Component', () => {
  ...
  it('renders the emergencies toggle before the month label and places add appointment next to status', () => {
    render(
      <Header
        {...defaultProps}
        showAddButton
    ...
    expect(emergenciesPill.compareDocumentPosition(monthLabel)).toBe(
