export const PricingPlans = [
  {
    ...
    amountYearly: "$0",
    amountLabel: "",
    description: "Perfect for new or small practices exploring on your own.",
  ...
  },
  {
    ...
    amountLabel: "",
    description:
      "For organisations to operate with scalability, control, and security.",
